...
export const getMessageUsersService =
  async (): Promise<Api.Message.GetMessageUsers.Response> => {
    return AxiosConfig.get<
      Api.Message.GetMessageUsers.Response,
      AxiosResponse<Api.Message.GetMessageUsers.Response>
    >("/message/users").then((res) => res.data);
  };
...
export const getMessagesService = async (
  ...
  >(`/message/${payload.receiverId}`).then((res) => res.data);
};
